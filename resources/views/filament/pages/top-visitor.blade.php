    ...
    <div class="print-container dark:bg-gray-800 bg-white w-full ">
        ...
        <table class="w-full divide-y divide-gray-300">
            ...
            <tbody class="divide-y divide-gray-200">
                <tr>
                    <td class="whitespace-normal py-2 pr-3 text-left text-xs font-medium" style="padding-left: 16px;">John Doe</td>
                    <td class="whitespace-normal px-3 py-2 text-left text-xs" style="padding-left: 16px;">Information Teachnology</td>
                    <td class="whitespace-normal px-3 py-2 text-left text-xs" style="padding-left: 16px;">1st Year</td>
                    <td class="whitespace-normal px-3 py-2 text-left text-xs" style="padding-left: 16px;">Campus</td>
                    <td class="whitespace-normal px-3 py-2 text-left text-xs" style="padding-left: 16px;">100</td>
                </tr>
