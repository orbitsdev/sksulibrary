...
{{-- <img style="width: 120px; height: 120px" src="{{ public_path('storage/students-profile/f9WgazUX0Q5I3w2Fz2KKC6nQP5nGG2-metaMzc5OTcwNzM1XzEwMjY4Njg0NTE3NzM1NzVfMjkzNjYxMTE1MTI0MDUyMjg2N19uLnBuZw==-.png') }}"> --}}
{{-- <img style="width: 120px; height: 120px" src="{{ public_path('storage/students-profile/f9WgazUX0Q5I3w2Fz2KKC6nQP5nGG2-metaMzc5OTcwNzM1XzEwMjY4Njg0NTE3NzM1NzVfMjkzNjYxMTE1MTI0MDUyMjg2N19uLnBuZw==-.png') }}">
<h1>{{ $title }}</h1>
<p>{{ $date }}</p>
        ...
        <tr>
            <td>
                @if(!empty($student->profile))
                    <img style="width: 120px; height: 120px" src="{{ public_path('storage/'.$student->profile) }}">
                @endif
            </td>
            <td>
                @php
            ...
            @if (Storage::disk('public')->exists($filePath))
                <img style="width: 120px; height: 120px" src="{{ public_path('storage/'.$filePath) }}">
            @endif
                ...
                <div class="card-content">
                    ...
                    <div class="card-header-logo">
                        <div class="image-box box-1">
                            <img src="{{ public_path('images/sksulogo.png') }}" alt="sksu-logo">
                        </div>
                    ...
                    <div class="student-information">
                        <div class="student-box sb1">
                            ...
                            <div class="id-container ">
                                <img src="{{public_path('storage/'.$student->profile)}}" alt="image">
                            </div>
                    ...
                    <div class="bar-code-area">
                        ...
                        @if (Storage::disk('public')->exists($filePath))
                            <img src="{{public_path('storage/'.$filePath) }}" alt="QR Code">
                        @endif
