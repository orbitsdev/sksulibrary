# SKSU Library Queue System - User Manual (Local Testing)
...
1. Go to: `http://sksulibrary.test/admin`
...
1. Go to: `http://sksulibrary.test/teller/login`
...
```
http://sksulibrary.test/queque/monitor
```
...
2. **Open the Monitor URL**
   ...
   - Go to `http://sksulibrary.test/queque/monitor`
...
| Page | URL |
|------|-----|
| Admin Panel | `http://sksulibrary.test/admin` |
| Teller Login | `http://sksulibrary.test/teller/login` |
| Queue Monitor | `http://sksulibrary.test/queque/monitor` |
